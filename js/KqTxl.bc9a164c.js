    ...
    "445c": function (t, e, n) {
      ...
      var o = function () {
          var t = this,
            e = t.$createElement,
            n = t._self._c || e;
          return n("header", { staticClass: "nav-bar" }, [
            t.headerData.leftText
              ? n("div", { staticClass: "nav-bar-left" }, [
                  n(
                    "div",
                    {
                      on: {
                    ...
                    [
                      n("i", { staticClass: "iconfont iconicon-back" }),
                      n("div", { staticClass: "nav-bar-txt" }, [
              ...
              : t._e(),
            n("div", { staticClass: "nav-bar-title" }, [
              t._v(t._s(t.headerData.title)),
            ]),
            n("div", { staticClass: "nav-bar-right" }, [
    ...
    "510f": function (t, e, n) {
      ...
      var c = {
          ...
          beforeRouteLeave: function (t, e, n) {
            var o = [];
            if (
              ((o = this.$store.state.router.keepAlive), "GysXmbm" === e.name)
            ) {
            ...
            for (
              var c = [], s = 0;
              s < this.$store.state.router.footMeun.length;
              s++
            )
          ...
          methods: {
            NativeLoadCA: function () {
              ...
              this.$bridge.callhandler("LoadCA", "{page:1}", function (e) {
                var n = JSON.parse(e);
                console.log("goScanView------", e), (t.Native_CaLoad = n);
              });
            },
          ...
          methods: {
            ...
            NativeScan: function () {
              ...
              this.$bridge.callhandler("goScanView", "{page:1}", function (e) {
                var n = JSON.parse(e);
                console.log("goScanView------", e), (t.Native_ScanData = n);
              });
            },
                    ...
                    if (
                      ...
                      if (((n = JSON.parse(e)), 0 === n.router.length))
                        ...
                        for (var a = 0; a < n.router.length; a++) {
                          if (
                            ((o = n.router[a].children),
                            3 === t.userInfo.zzxz &&
                              "SJDBCD_GYS" === n.router[a].component)
                          ) {
                            for (var i = 0; i < o.length; i++)
                              0 !== i &&
                              i % 2 === 0 &&
                              i === Math.floor(o.length / 2)
                                ? (o[i].activeIcon = o[i].icon)
                                : (o[i].activeIcon = o[i].icon + "-active");
                            t.$store.commit("router/SET_Foot_Meun", o);
                            break;
                          }
                          if (
                            5 === t.userInfo.zzxz &&
                            "JBR_HOME" === n.router[a].component
                          ) {
                            for (var r = 0; r < o.length; r++)
                              0 !== r &&
                              r % 2 === 0 &&
                              r === Math.floor(o.length / 2)
                                ? (o[r].activeIcon = o[r].icon)
                                : (o[r].activeIcon = o[r].icon + "-active");
                            t.$store.commit("router/SET_Foot_Meun", o),
                          ...
                          if (
                            4 === t.userInfo.zzxz &&
                            "SJDBCD_DLJG" === n.router[a].component
                          ) {
                            for (var c = 0; c < o.length; c++)
                              0 !== c &&
                              c % 2 === 0 &&
                              c === Math.floor(o.length / 2)
                                ? (o[c].activeIcon = o[c].icon)
                                : (o[c].activeIcon = o[c].icon + "-active");
                          ...
                          if (
                            ...
                            for (var s = 0; s < o.length; s++)
                              ...
                              s === Math.floor(o.length / 2)
                                ? (o[s].activeIcon = o[s].icon)
                                : (o[s].activeIcon = o[s].icon + "-active");
                            t.$store.commit("router/SET_Foot_Meun", o);
                            break;
                          }
                          for (var l = 0; l < o.length; l++)
                            ...
                            l === Math.floor(o.length / 2)
                              ? (o[l].activeIcon = o[l].icon)
                              : (o[l].activeIcon = o[l].icon + "-active");
                          t.$store.commit("router/SET_Foot_Meun", o);
                          break;
                        }
                        console.log(
    ...
    c315: function (t, e, n) {
      ...
      var o = function () {
          ...
          return n(
            "div",
            [
              n("headerBar", { attrs: { "header-data": t.headerData } }),
                        ...
                        n(
                          ...
                          [
                            t._l(t.list, function (e, o) {
                              return n("div", { key: o }, [
                                -1 !== e.name.indexOf(t.value) ||
                                -1 !== e.mobile.indexOf(t.value)
                                  ? n(
                                      "div",
                                      {
                                      ...
                                      [
                                        ...
                                        n("div", { staticClass: "name flex" }, [
                                          n("span", { staticClass: "xm" }, [
                                            t._v(t._s(e.name) + " "),
                                          ]),
                                          n("span", [t._v(t._s(e.mobile))]),
                                        ]),
                                      ]
                                    )
                                  : t._e(),
                            ...
                            t.serachResult ? t._e() : n("div", [t._m(0)]),
                          ],
                          2
                        ),
                      ]
        ...
        a = [
          function () {
            var t = this,
              e = t.$createElement,
              n = t._self._c || e;
            return n("div", { staticClass: "status" }, [
              n("div", { staticClass: "status-icon no-xiangmu" }),
              n("h3", [t._v("暂无联系人")]),
            ]);
          },
        ],
        ...
        c = n("445c"),
        s = {
          components: { headerBar: c["a"], FooterNav: i["a"] },
          mixins: [r["d"]],
          data: function () {
            return {
              show: !1,
              serachResult: !1,
              value: "",
              headerData: { title: "通讯录", leftUrl: "back", leftText: " " },
              indexList: [
                "a",
                "b",
                "c",
          ...
          created: function () {
            this.$store.commit("router/SET_Foot_Num", 3), this.getList();
          },
          methods: {
            goCall: function (t) {
              try {
            ...
            getList: function () {
              var t = this;
              this.$store
                .dispatch("erp/queryContactsAction", { xm: "" })
                .then(function (e) {
                  t.list = e.contacts;
            ...
            serachChange: function () {
              for (var t = 0, e = 0; e < this.list.length; e++)
                (-1 === this.list[e].name.indexOf(this.value) &&
                  -1 === this.list[e].mobile.indexOf(this.value)) ||
                  t++;
