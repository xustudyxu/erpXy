(function (t) {
  function n(n) {
    for (
      var o, i, a = n[0], u = n[1], s = n[2], d = 0, m = [];
      d < a.length;
      d++
    )
      (i = a[d]),
  ...
  function a(t) {
    return (
      ...
      "js/" +
      ({
        "AddressAdd~GoodsList~InvoiceAdd~InvoiceAddressAdd~InvoiceEdit~OrderServiceApply":
          "AddressAdd~GoodsList~InvoiceAdd~InvoiceAddressAdd~InvoiceEdit~OrderServiceApply",
        ...
        "BidDetail~BidMemberEdit~BidMemberView~BidRule~DbsxXxxx~OrderEvaluation~ShglAdd~ShglView~WdxmBj~Wdxmx~5c2cc8bf":
          "BidDetail~BidMemberEdit~BidMemberView~BidRule~DbsxXxxx~OrderEvaluation~ShglAdd~ShglView~WdxmBj~Wdxmx~5c2cc8bf",
        BidDetail: "BidDetail",
        ...
        "BuyCart~MallCategory~MallHome~MallMine":
          "BuyCart~MallCategory~MallHome~MallMine",
        BuyCart: "BuyCart",
        ...
        n.push(
          (i[t] = new Promise(function (n, e) {
            for (
              var o =
                  ...
                  ({
                    "AddressAdd~GoodsList~InvoiceAdd~InvoiceAddressAdd~InvoiceEdit~OrderServiceApply":
                      "AddressAdd~GoodsList~InvoiceAdd~InvoiceAddressAdd~InvoiceEdit~OrderServiceApply",
                    AddressAdd: "AddressAdd",
                    "GoodsList~GysLxrxx~RecommendList":
                      "GoodsList~GysLxrxx~RecommendList",
                    GoodsList: "GoodsList",
                    InvoiceAdd: "InvoiceAdd",
                    InvoiceAddressAdd: "InvoiceAddressAdd",
              ...
              if ("stylesheet" === s.rel && (d === o || d === r)) return n();
            }
            var m = document.getElementsByTagName("style");
            for (a = 0; a < m.length; a++) {
              (s = m[a]), (d = s.getAttribute("data-href"));
              if (d === o || d === r) return n();
            }
      ...
      (function (t, n) {
        ...
        if (r) {
          ...
          if (m) {
            ...
            f && ((a = parseFloat(f[1])), (u = parseFloat((1 / a).toFixed(2)))),
              l &&
                ((a = parseFloat(l[1])), (u = parseFloat((1 / a).toFixed(2))));
          }
        }
        if (!a && !u) {
        ...
        if ((i.setAttribute("data-dpr", a), !r))
          if (
            ...
            b.appendChild(r), o.write(b.innerHTML);
          }
        function x() {
          var n = i.getBoundingClientRect().width;
          n / a > 540 && (n = 540 * a);
          var e = n / 3.75;
          (i.style.fontSize = e + "px"), (s.rem = t.rem = e);
        }
        t.addEventListener(
          "resize",
          function () {
            clearTimeout(e), (e = setTimeout(x, 300));
          },
          !1
        ),
          t.addEventListener(
          ...
          (s.rem2px = function (t) {
            ...
            return "string" === typeof t && t.match(/rem$/) && (n += "px"), n;
          }),
          (s.px2rem = function (t) {
            var n = parseFloat(t) / this.rem;
            return "string" === typeof t && t.match(/px$/) && (n += "rem"), n;
          });
  ...
  "176e": function (t, n, e) {
    ...
    l.interceptors.request.use(
        ...
        return regeneratorRuntime.async(function (i) {
          while (1)
            switch ((i.prev = i.next)) {
              case 0:
                return (
                  -1 === t.url.toLowerCase().indexOf("/login/") &&
                    (console.log("token--------", Object(a["c"])()),
                    Object(a["c"])() && (t.headers["token"] = Object(a["c"])()),
                    c["a"].getters.token
                      ? (t.headers["token"] = c["a"].getters.token)
                      : ((n = JSON.parse(window.localStorage.getItem("token"))),
                        n && (t.headers["token"] = n))),
                  t.baseUrl
                    ? (t.url = t.baseUrl + t.url)
                    : 0 === t.url.toLowerCase().indexOf("/app/") &&
                      (t.url = Object(a["d"])("VUE_APP_API") + t.url),
                  ("undefined" === typeof t.encryption || t.encryption) &&
                    t.data &&
                    ((e = { timestamp: h(), nonce: p(), language: "zh_cn" }),
                    (o = Object.assign(t.data || {}, e)),
                    console.info("請求url====>", t.url),
                    (t.data = { params: Object(s["b"])(o, !0) })),
                  "get" === t.method &&
                    (t.params = f(
      ...
      function (t) {
        return console.log("错误=====", t), Promise.reject(t);
      }
    );
    var h = function () {
    ...
    l.interceptors.response.use(
      function (t) {
        ...
        if ("token is not valid!" !== n)
          return (
            (e =
              "用户名不存在！" === n.text || "登录失败，密码错误！" === n.text
                ? "登录失败！"
                : n.text),
            1 !== n.state
              ? (Message({ message: e, type: "error", duration: 5e3 }),
                Promise.reject("error"))
              : n
          );
        var o = JSON.parse(window.localStorage.getItem("tokenout"));
        console.info("tokenout====", o),
          u["a"].replace({ path: "login", redirect: "/" });
      },
      function (t) {
        var n = 0;
        try {
          (n = t.response.data.status), console.log(n, t.response.data.message);
        } catch (e) {
        ...
        if (401 === n)
          ...
          d.$router.push({ path: "/404", params: { msg: n } });
        else
          try {
  ...
  "251e": function (t, n, e) {
    ...
    n["a"] = { namespaced: !0, getters: r, state: i, mutations: c, actions: a };
  },
  2788: function (t, n, e) {
    "use strict";
    e("d3b7");
    var o = e("365c"),
      ...
      d = function (t, n, e, r) {
        return o["a"].request({
          ...
          method: "post",
          token: !0,
          data: { zzid: t, xmid: n, ggid: e, sftyyq: r },
        });
      },
    ...
    n["a"] = { namespaced: !0, getters: l, state: f, mutations: h, actions: p };
  },
  "2a08": function (t, n, e) {
    "use strict";
    var o = e("30fc"),
            ...
            var t =
              ...
              o =
                arguments.length > 2 && void 0 !== arguments[2]
                  ? arguments[2]
                  : "加载中...";
            n || ((n = r()), document.body.appendChild(n.$el)), n.show(t, e, o);
          },
          hide: function () {
            n && n.hide();
          },
  ...
  "2eca": function (t, n, e) {
    ...
    e("fb6a"),
      ...
      (n.formatMoney = function (t) {
        if (t) return (t = Number(t)), "￥ " + t.toFixed(2);
      }),
        ...
        if (t)
          return 6 === t.length
            ...
            : t.substring(0, t.length - 6) +
                "天" +
                t.substring(t.length - 6, t.length - 4) +
                "时" +
                t.substring(t.length - 4, t.length - 2) +
                "分" +
      ...
      (n.Cgfs = function (t) {
        return [
          { value: "00380002", label: "公开招标" },
          { value: "00380018", label: "比选" },
          { value: "00380099", label: "协议谈判" },
          { value: "00380003", label: "邀请招标" },
          { value: "00380004", label: "谈判采购" },
          { value: "00380005", label: "询比文件采购" },
          { value: "00380006", label: "直接采购" },
          { value: "00380012", label: "竞价采购" },
          { value: "00380013", label: "询比采购" },
          { value: "00380014", label: "电商比价" },
          { value: "00380017", label: "竞争性磋商" },
          { value: "00380004", label: "竞争性谈判" },
        ];
      }),
  ...
  "30fc": function (t, n, e) {
    ...
    var o = function () {
        ...
        return e(
          "div",
          {
            ...
            on: {
              ...
              click: function (n) {
                return (
                  n.stopPropagation(), n.preventDefault(), t.loadingFadeClick(n)
                );
              },
            },
          },
          [
            e(
              ...
              [
                t._t("default", [
                  e("span", { staticClass: "loading-icon progress" }),
                ]),
                t.indicatorText
                  ? e("div", {
                      staticClass: "indicator-text",
                      domProps: { innerHTML: t._s(t.indicatorText) },
                    })
                  : t._e(),
              ],
              2
      ...
      r = {
        ...
        mounted: function () {
          (this.isShow = this.value || !1), this.initOptionsData();
        },
        methods: {
          initOptionsData: function () {
            "boolean" === typeof this.options.isFixed &&
              (this.isFixed = this.options.isFixed),
              "boolean" === typeof this.options.isShowMask &&
                (this.isShowMask = this.options.isShowMask),
              "boolean" === typeof this.options.autoRefresh &&
                (this.autoRefresh = this.options.autoRefresh),
              "boolean" === typeof this.options.isShowAnimation &&
                (this.isShowAnimation = this.options.isShowAnimation),
              this.options.indicatorText &&
                "string" === typeof this.options.indicatorText &&
                (this.indicatorText = this.options.indicatorText);
          },
          show: function () {
            var t =
                arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
      ...
      f = (function () {
        function t() {
          var n =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : Object(a["d"])("VUE_APP_BASE_API");
          Object(o["a"])(this, t), (this.baseUrl = n), (this.queue = {});
        }
        return (
          Object(i["a"])(t, [
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  console.info(
                    "config.headers========" + JSON.stringify(n.headers)
                  ),
                  n
                );
              },
            ...
            },
            {
              ...
              value: function (t, n) {
                ...
                t.interceptors.request.use(
                  function (t) {
                    return (
                      Object.keys(e.queue).length || m.showLoading(),
                      (e.queue[n] = !0),
                      t &&
                        t.data &&
                        (t.data = u["sm2"].doEncrypt(
                          JSON.stringify(t.data),
                          "045ea58d916f18bdc9571986ee85fa7aa2c5d361b5fd7337bf74bcb6308468d35d709626f2a7b27ec271f3f4f215e074c8d7709950465aa23981749c3ea1381d41",
                          1
                        )),
                      t
                    );
                  ...
                  t.interceptors.response.use(
                    function (t) {
                      return (
                        ...
                        1 === t.data.state
                          ? t.data
                          : (Object(d["a"])(t.data.text),
                            Promise.reject(t.data.text))
                      );
                    },
                    function (t) {
                      if (
                        ...
                        console.info("error.response-------", t.response),
                        console.info("error.message-------", t.message),
                        null == t.response || "" === t.response)
                      )
                        return (
                          console.info("error.message----aaa---", t.message),
                          Promise.reject("网络请求错误")
                        );
            ...
            },
            {
              key: "request",
              value: function (t) {
                var n = c.a.create({ timeout: 12e3 });
                return (
                  (t = Object.assign(this.getInsideConfig(t), t)),
  ...
  4298: function (t, n, e) {
    ...
    function i(t, n) {
      return "undefined" === typeof t ||
        null === t ||
        "" === t ||
        "null" === JSON.stringify(t).toLowerCase()
        ? null
        : o["Base64"].encode(
            !0 === n || (n && "true" === n.toLowerCase())
              ? JSON.stringify(t)
              : t,
            "utf-8"
          );
  ...
  4360: function (t, n, e) {
    ...
    var o = e("2b0e"),
      ...
      u = function (t) {
        return r["a"].request({
          url:
            "/app/router/getAppBottomRoleRouteJson?token=" + Object(c["c"])(),
          method: "post",
          token: !0,
          data: t,
        });
            ...
            s(n)
              .then(function (i) {
                var r = JSON.stringify(i),
                  a = JSON.parse(r);
                1 === a.state
                  ? (Object(c["k"])(a.data.token),
                    Object(c["n"])(n.username),
                    Object(c["j"])(n.password),
                    e("SET_MHUSER_INFO", a.data),
                    e("SET_IS_MHLOGIN", !0),
                    t(a.data))
                  : o(a.text);
              })
              ...
              d(n)
                .then(function (n) {
                  var i = JSON.stringify(n),
                    r = JSON.parse(i);
                  1 === r.state
                    ? (Object(c["k"])(r.data.token),
                      Object(c["n"])(r.data.dlh),
                      Object(c["j"])(r.data.password),
                      e("SET_MHUSER_INFO", r.data),
                      e("SET_IS_MHLOGIN", !0),
                      t(r.data))
                    : o(r.text);
                })
      ...
      g = { namespaced: !0, getters: p, state: h, mutations: b, actions: x },
      S = function (t) {
        var n = t.username,
          e = t.password;
        return r["a"].request({
      ...
      w = { userInfo: "", userName: "Zee", isLogin: !1, rules: {} },
      A = {},
      _ = {
      ...
      L = {
        ...
        zc: function (t, n) {
          ...
          return new Promise(function (t, n) {
            j({
              ...
              .then(function (o) {
                1 === o.state
                  ? (Object(c["k"])(o.data.token),
                    e("SET_USER_INFO", o.data),
                    t(o))
                  : n(new Error("错误"));
              })
              .catch(function (t) {
        ...
        login: function (t, n) {
          var e = t.commit,
            ...
            i = n.password;
          return new Promise(function (t, n) {
            S({ username: o, password: i })
              .then(function (r) {
                var a = JSON.stringify(r),
                  u = JSON.parse(a);
                1 === u.state
                  ? (Object(c["m"])(u.data.id),
                    Object(c["k"])(u.data.token),
                    Object(c["n"])(o),
                    Object(c["j"])(i),
                    e("SET_IS_LOGIN", !0),
                    e("SET_USER_INFO", u.data),
                    t(u.data))
                  : n(u.text);
              })
              .catch(function (t) {
      ...
      z = { getters: A, state: w, mutations: _, actions: L },
      P = function (t) {
        var n = t.page,
          e = t.userid;
        return r["a"].request({
      ...
      E = function (t, n, e, o, i) {
        return r["a"].request({
          ...
          method: "post",
          token: t,
          data: { pageno: n, zzid: e, xmmc: o, jqdbsj: i },
        });
      },
      q = { message: "" },
      k = {},
      ...
      I = { namespaced: !0, getters: k, state: q, mutations: X, actions: B },
      C = e("2788"),
      M = function (t) {
        return r["a"].request({
      ...
      G = function (t) {
        return r["a"].request({
          url:
            "/app/web/authentication/wf/getGysLcxd?token=" + Object(c["c"])(),
          method: "post",
          token: !0,
          data: t,
        });
      ...
      $ = function (t) {
        return r["a"].request({ url: t, method: "post", token: !0 });
      },
      tt = function (t) {
        return r["a"].request({
      ...
      ut = {
        ...
        getGysJdxqAction: function (t, n) {
          t.commit;
          return (
            console.log("xmid----", n.xmid),
            console.log("appsrvurl----", n.appsrvurl),
            new Promise(function (t, e) {
              V(n.xmid, n.zzid, n.appsrvurl)
                .then(function (n) {
                  var o = JSON.stringify(n),
                    i = JSON.parse(o);
                  1 === i.state ? t(i.data) : e(i.text);
      ...
      ft = { userInfo: "", userName: "Zee", isLogin: !1, rules: {} },
      lt = {},
      ht = {
        SET_USER_INFO: function (t, n) {
          t.userInfo = n;
      ...
      bt = { getters: lt, state: ft, mutations: ht, actions: pt },
      xt = e("251e"),
      gt = function (t) {
        return r["a"].request({
      ...
      qt = {
        ...
        clearSearchHistory: function (t, n) {
          var e = t.commit;
          "0" === n.key
            ? e("SET_WybmSERACH_HISTOR", Object(c["clearSearch"])(kt(n.key)))
            : e("SET_WdxmSERACH_HISTOR", Object(c["clearSearch"])(kt(n.key)));
        },
        updateHostorList: function (t, n) {
          var e = t.commit;
          "0" === n.key
            ? e("SET_WybmSERACH_HISTOR", Object(c["h"])(kt(n.key), n.query))
            : e("SET_WdxmSERACH_HISTOR", Object(c["h"])(kt(n.key), n.query));
        },
    ...
    var Xt = { getters: Pt, state: zt, mutations: Et, actions: qt },
      Bt = e("d342"),
      It = {
      ...
      Gt = {
        ...
        clearJbrSearchHistory: function (t, n) {
          var e = t.commit;
          "3" === n.key
            ? e("SET_DbsxSERACH_HISTOR", Object(c["clearSearch"])(Tt(n.key)))
            : e("SET_WdxmSERACH_HISTOR", Object(c["clearSearch"])(Tt(n.key)));
        },
        updateJbrSearchList: function (t, n) {
          var e = t.commit;
          "3" === n.key
            ? e("SET_DbsxSERACH_HISTOR", Object(c["h"])(Tt(n.key), n.query))
            : e("SET_WdxmSERACH_HISTOR", Object(c["h"])(Tt(n.key), n.query));
        },
        deleteSearchHistory: function (t, n) {
          t.commit;
        },
    ...
    var Dt = { getters: Ct, state: It, mutations: Mt, actions: Gt },
      Nt = function (t) {
        return r["a"].request({
      ...
      Vt = function (t) {
        ...
        return r["a"].request({
          ...
          method: "post",
          data: { ztmc: n, ztdm: e, lxrdh: o, mm: i, email: c, fileList: a },
        });
      },
      Ut = function (t) {
        return r["a"].request({
      ...
      Ft = function (t, n, e) {
        return (
          console.info("data===", t, "baseurl=====", n, "token=====", e),
          r["a"].request({
            baseURL: n,
      ...
      mn = {},
      fn = { getters: sn, state: un, mutations: dn, actions: mn },
      ln = function (t) {
        return r["a"].request({
      ...
      vn = { message: "", fhbh: "", spmxList: [], active: "" },
      On = {},
      wn = {
    ...
    function qe(t, n) {
      return Object(Pn["a"])({
        ...
        method: "post",
        data: { e_product_id: t, product_id: n },
        encryption: !0,
      });
    }
    function ke(t, n) {
    ...
    var De = {
      ...
      Je = { namespaced: !0, state: De, mutations: Ne, actions: Re };
    function We(t) {
      return Object(Pn["a"])({
    ...
    var Wo = { orderId: {}, userInfo: {}, queryInfo: {} },
      Ho = {
      ...
      Qo = Fo.a.fixedHeader,
      $o = Fo.a.sidebarLogo,
      ti = { showSettings: Ko, fixedHeader: Qo, sidebarLogo: $o },
      ni = {
      ...
      oi = { namespaced: !0, state: ti, mutations: ni, actions: ei },
      ii = e("ade3");
    function ri(t) {
      return Object(Pn["a"])({
    ...
    var mi,
      ...
      yi = {
        ...
        login: function (t, n) {
          ...
          return (
            ...
            new Promise(function (t, o) {
              ai({ username: n.userAccount, password: n.passWord })
                .then(function (n) {
                  var o = n.data;
          ...
          return new Promise(function (t, o) {
            si(e.token)
              .then(function (e) {
                ...
                var r = i.userInfo;
                console.log(r, i), n(li, { userInfo: r }), t(i);
              })
              .catch(function (t) {
                o(t);
              });
        ...
        turnToPage: function (t, n) {
          ...
          return new Promise(function (t) {
            e(pi, n.token), e(li, n), t(n);
          });
        },
      },
      ji = {
        userInfo: function (t) {
          return console.info("userInfo", t.userInfo), t.userInfo;
        },
      },
      vi = {
        namespaced: !0,
      ...
      Ci = {
        ...
        dlePageList: function (t, n) {
          ...
          i = o.pageList;
          var r = i.indexOf(n);
          -1 !== r && i.splice(r, 1), e("setPageList", i);
        },
      ...
      Ji = function (t) {
        return r["a"].request({
          url: "/app/rl/kqglappservice/submitSign",
          method: "post",
          token: !0,
          data: t,
        });
      ...
      or = function (t) {
        return r["a"].request({
          url: "/ananymous/app/version/getVersion/APP",
          method: "get",
          token: !1,
          data: t,
        });
      ...
      ir = function (t) {
        return r["a"].request({
          url: "/ananymous/app/version/getVersion/Ios",
          method: "get",
          token: !1,
          data: t,
        });
  ...
  "56d7": function (t, n, e) {
    "use strict";
    e.r(n);
    e("4de4"), e("e260"), e("e6cf"), e("cca6"), e("a79d"), e("124a");
    var o = e("2b0e"),
      i = e("a18c"),
      r = e("4360"),
      c = e("2eca"),
    ...
    var p = {
        ...
        created: function () {
          window.localStorage.getItem("cyyList") ||
            window.localStorage.setItem(
              "cyyList",
              JSON.stringify(["情况属实", "情况不属实", "审批通过"])
            ),
            Object(f["l"])(
              "VUE_APP_BASE_API",
              "http://erp.xinyuan.com.cn:7003/xyerp"
            ),
            Object(f["l"])(
              "VUE_APP_SC_BASE_API",
              "http://erp.xinyuan.com.cn:7003/xyerp"
        ...
        mounted: function () {
          ...
          (window["jpushAction"] = function (n) {
            ...
            (window["getRotuerPage"] = function (n) {
              return (
                console.info("keepAlive=====", t.$store.state.router.keepAlive),
            ...
            (window["goRotuerPage"] = function (n) {
              console.info(
                ...
                console.info(
                  "goRotuerPage==2===",
                  t.$store.state.router.keepAlive.length - 2
                ),
                console.info(
                  "goRotuerPage==3===",
                  t.$store.state.router.keepAlive[
                ...
                t.$store.state.router.keepAlive[
                  ...
                  ? t.$router.push({
                      name: t.$store.state.router.keepAlive[
                        t.$store.state.router.keepAlive.length - 2
                      ],
                    })
                  : t.$router.push({ name: "MhHome" });
            }),
            this.getJpushPage();
        },
        methods: {
          getPhoneType: function () {
            try {
              ...
              "android" === t &&
                (console.info("phoneType==111======"),
                e.e("chunk-76e9fb09").then(e.t.bind(null, "e7e3", 7)),
                console.info("phoneType==222======"));
            } catch (n) {
              console.log(n);
            }
          },
    ...
    v["a"].localize(L),
      ...
      v["a"].extend("TelOrMobile", {
        ...
        validate: function (t) {
          return (
            new RegExp(/^(\(\d{3,4}\)|\d{3,4}-|\s)?\d{7,14}$/).test(t) ||
            new RegExp(/^1[3456789]\d{9}$/).test(t)
          );
        },
      }),
      ...
      N = (function () {
        function t() {
          var n =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : Object(f["d"])("VUE_APP_BASE_API");
          Object(C["a"])(this, t), (this.baseUrl = n), (this.queue = {});
        }
        return (
          Object(M["a"])(t, [
            {
                ...
                t.interceptors.request.use(
                  function (t) {
                    return (
                      t.encryption &&
                        (console.info("請求url====>", t.url),
                        (t.data = { params: Object(G["b"])(t.data, !0) })),
                      Object.keys(e.queue).length || D.showLoading(),
                      (e.queue[n] = !0),
                      t &&
                        t.data &&
                        (t.data = T["sm2"].doEncrypt(
                          JSON.stringify(t.data),
                          "045ea58d916f18bdc9571986ee85fa7aa2c5d361b5fd7337bf74bcb6308468d35d709626f2a7b27ec271f3f4f215e074c8d7709950465aa23981749c3ea1381d41",
                          1
                        )),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var n = P.a.create({ timeout: 12e3 });
                return (
                  (t = Object.assign(t.config, t)),
                  this.interceptors(n, t.url, t.token),
                  n(t)
                );
              },
      ...
      return (
        (n = t.token
          ? {
              ...
              baseURL: t.baseUrl
                ? Object(f["d"])("VUE_APP_SC_BASE_API")
                : Object(f["d"])("VUE_APP_BASE_API"),
              headers: {
                "Content-Type":
                  "upload" === t.method
  ...
  "80d5": function (t, n, e) {
    ...
    var f = function (t, n) {
        ...
        if ((o["a"].get(e, []) && (i = o["a"].get(e, [])), 0 === i.length)) {
          i.push({ key: t, value: n }), o["a"].set(e, i);
          var c = o["a"].get(e, []);
          console.log("保存url后------------------", c);
        } else {
          for (var a = 0; a < i.length; a++)
            (("VUE_APP_BASE_API" !== t || t !== i[a].key) &&
              ("VUE_APP_SC_BASE_API" !== t || t !== i[a].key) &&
              ("VUE_APP_API" !== t || t !== i[a].key) &&
              ("VUE_APP_FILE_API" !== t || t !== i[a].key) &&
              ("VUE_APP_CFCA_API" !== t || t !== i[a].key)) ||
              ((i[a].value = n), o["a"].set(e, i), (r = !0));
          r || (i.push({ key: t, value: n }), o["a"].set(e, i));
        }
        var u = o["a"].get(e, []);
    ...
    function O(t, n) {
      ...
      if (null != n && n.length > 0) {
        ...
        if (-1 === m) {
          ...
          if (0 === d) return;
          d > 0 && s.splice(d, 1), s.unshift(n), i && s.length > i && s.pop();
        }
        o["a"].set(e, r);
      }
      return r;
    ...
    function w(t) {
      ...
      return m > -1 && (i = e[m][1]), i;
    }
  },
  "83d6": function (t, n) {
    t.exports = { title: "网上商城", fixedHeader: !1, sidebarLogo: !1 };
  },
  "8b55": function (t, n, e) {
    "use strict";
    e.d(n, "b", function () {
    ...
    e("fb6a"), e("4d63"), e("25f0"), e("466d"), e("5319");
    function o(t) {
      return (
        (t += ""),
        null == t || "" === t
  ...
  a18c: function (t, n, e) {
    ...
    var o = e("2909"),
      ...
      c = e("80d5"),
      a = function (t) {
        return Promise.all([e.e("Wdxm~Wybm"), e.e("Wdxm")])
          .then(
            function () {
              return t(e("61ea"));
            }.bind(null, e)
      ...
      p = function (t) {
        return Promise.all([e.e("Wdxmxmxq~Yqhlist~Yqhqr"), e.e("Yqhqr")])
          .then(
            function () {
              return t(e("efac"));
            }.bind(null, e)
      ...
      j = function (t) {
        return Promise.all([e.e("Wdxm~Wybm"), e.e("Wybm")])
          .then(
            function () {
              return t(e("122a"));
            }.bind(null, e)
      ...
      v = function (t) {
        return Promise.all([e.e("Wdxmxmxq~Yqhlist~Yqhqr"), e.e("Yqhlist")])
          .then(
            function () {
              return t(e("4d39"));
            }.bind(null, e)
      ...
      A = function (t) {
        return Promise.all([
          e.e("GoodsList~GysLxrxx~RecommendList"),
          e.e("GysLxrxx"),
        ])
          .then(
            function () {
      ...
      q = [
        { path: "/Wdxm", name: "Wdxm", component: a },
        { path: "/Wdxmxmxq", name: "Wdxmxmxq", component: u },
        { path: "/WdxmBj", name: "WdxmBj", component: S },
        { path: "/WdxmBjLs", name: "WdxmBjLs", component: y },
        { path: "/Wdxmwlxq", name: "Wdxmwlxq", component: s },
        { path: "/Wybm", name: "Wybm", component: j },
        { path: "/Yqhlist", name: "Yqhlist", component: v },
        { path: "/Xmfb", name: "Xmfb", component: O },
        { path: "/GysLxrxx", name: "GysLxrxx", component: A },
        { path: "/GysXmbm", name: "GysXmbm", component: w },
        { path: "/Cgggxx", name: "Cgggxx", component: d },
        { path: "/XmFbxq", name: "XmFbxq", component: m },
        { path: "/XmCqxx", name: "XmCqxx", component: f },
        { path: "/XmJggg", name: "XmJggg", component: l },
        { path: "/XmJggs", name: "XmJggs", component: h },
        { path: "/Jdxq", name: "Jdxq", component: g },
        { path: "/Yqhqr", name: "Yqhqr", component: p },
        { path: "/Zbjg", name: "Zbjg", component: b },
        { path: "/Xmggnr", name: "Xmggnr", component: x },
        { path: "/ShglIndex", name: "ShglIndex", component: _ },
        { path: "/ShglAdd", name: "ShglAdd", component: L },
        { path: "/ShglView", name: "ShglView", component: z },
        { path: "/ShglLzrz", name: "ShglLzrz", component: P },
        { path: "/ShglAddSp", name: "ShglAddSp", component: E },
      ],
      k = function (t) {
        return e
          .e("DbsxIndex")
      ...
      V = [
        { path: "/DbsxIndex", name: "DbsxIndex", component: k },
        { path: "/DbsxXxxx", name: "DbsxXxxx", component: X },
        { path: "/DbsxSpyj", name: "DbsxSpyj", component: B },
        { path: "/DbsxSubmit", name: "DbsxSubmit", component: I },
        { path: "/DbsxBack", name: "DbsxBack", component: C },
        { path: "/DbsxBackOneStep", name: "DbsxBackOneStep", component: M },
        { path: "/DbsxHq", name: "DbsxHq", component: G },
        { path: "/DbsxCyy", name: "DbsxCyy", component: T },
        { path: "/DbsxSjbqMore", name: "DbsxSjbqMore", component: D },
        { path: "/WdxmIndex", name: "WdxmIndex", component: H },
        { path: "/jbrsphome", name: "jbrsphome", component: N },
        { path: "/WddbXxxx", name: "WddbXxxx", component: R },
        { path: "/thrw", name: "thrw", component: J },
        { path: "/ShgysBj", name: "ShgysBj", component: W },
        { path: "/Xmxxxq", name: "Xmxxxq", component: Z },
      ],
      U = function (t) {
        return e
          .e("GgHtml")
      ...
      mt = [
        { path: "/GgHtml", name: "GgHtml", component: U },
        { path: "/GgImages", name: "GgImages", component: Y },
        { path: "/GgIframe", name: "GgIframe", component: F },
        { path: "/XtggIndex", name: "XtggIndex", component: K },
        { path: "/XtggGgxq", name: "XtggGgxq", component: Q },
        { path: "/GrzxIndex", name: "GrzxIndex", component: $ },
        { path: "/GrzxGrxx", name: "GrzxGrxx", component: tt },
        { path: "/GrzxGywm", name: "GrzxGywm", component: nt },
        { path: "/GrzxSysm", name: "GrzxSysm", component: et },
        { path: "/GysZc", name: "GysZc", component: ot },
        { path: "/Zjzc", name: "Zjzc", component: it },
        { path: "/GysZcSuccess", name: "GysZcSuccess", component: rt },
        { path: "/GysZhmm", name: "GysZhmm", component: ct },
        { path: "/GysZcXzjs", name: "GysZcXzjs", component: at },
        { path: "/GysZcxy", name: "GysZcxy", component: ut },
        { path: "/Search", name: "Search", component: dt },
        { path: "/MyUrl", name: "MyUrl", component: st },
      ],
      ft = function (t) {
        return Promise.all([e.e("dd~flash"), e.e("dd")])
          .then(
            function () {
              return t(e("5d2c"));
            }.bind(null, e)
      ...
      lt = function (t) {
        return Promise.all([e.e("dd~flash"), e.e("flash")])
          .then(
            function () {
              return t(e("ae4c"));
            }.bind(null, e)
      ...
      ht = [
        { path: "/flash", name: "flash", component: lt },
        { path: "/dd", name: "dd", component: ft },
      ],
      pt = function (t) {
        return e
          .e("sjlogin")
      ...
      bt = function (t) {
        return Promise.all([
          e.e("BuyCart~MallCategory~MallHome~MallMine"),
          e.e("MallHome"),
        ])
          .then(
            function () {
      ...
      Vt = [
        ...
        { path: "/OrderSnapshot", name: "OrderSnapshot", component: Zt },
        { path: "/TyAddressList", name: "TyAddressList", component: _t },
        { path: "/TyInvoiceList", name: "TyInvoiceList", component: Tt },
        { path: "/GoodsCompare", name: "GoodsCompare", component: vt },
        { path: "/OrderApproval", name: "OrderApproval", component: Ht },
        { path: "/MallXxtxInDetail", name: "MallXxtxInDetail", component: Wt },
        { path: "/MallXxtxIndex", name: "MallXxtxIndex", component: Jt },
        {
          path: "/InvoiceAddressAdd",
          name: "InvoiceAddressAdd",
          component: Rt,
        },
        { path: "/sjlogin", name: "sjlogin", component: pt },
        { path: "/MallHome", name: "MallHome", component: bt },
        { path: "/MallCategory", name: "MallCategory", component: xt },
        { path: "/GoodsList", name: "GoodsList", component: gt },
        { path: "/GoodsDetail", name: "GoodsDetail", component: St },
        { path: "/EvaluationList", name: "EvaluationList", component: yt },
        { path: "/BuyCart", name: "BuyCart", component: Ot },
        { path: "/ConfirmOrder", name: "ConfirmOrder", component: wt },
        { path: "/AddressList", name: "AddressList", component: At },
        { path: "/AddressAdd", name: "AddressAdd", component: Lt },
        { path: "/InvoiceEdit", name: "InvoiceEdit", component: Nt },
        { path: "/MallMine", name: "MallMine", component: zt },
        { path: "/MyOrder", name: "MyOrder", component: Pt },
        { path: "/OrderDetail", name: "OrderDetail", component: Et },
        { path: "/OrderExpress", name: "OrderExpress", component: qt },
        {
          path: "/OrderEvaluationList",
          name: "OrderEvaluationList",
          component: kt,
        },
        { path: "/OrderEvaluation", name: "OrderEvaluation", component: Xt },
        { path: "/OrderServiceList", name: "OrderServiceList", component: Bt },
        {
          path: "/OrderServiceApply",
          name: "OrderServiceApply",
          component: It,
        },
        { path: "/OrderServiceView", name: "OrderServiceView", component: Mt },
        { path: "/InvoiceList", name: "InvoiceList", component: Gt },
        { path: "/InvoiceAdd", name: "InvoiceAdd", component: Dt },
        { path: "/RecommendList", name: "RecommendList", component: jt },
      ],
      Ut = function (t) {
        return e
          .e("mhlogin")
      ...
      tn = [
        { path: "/", name: "mhlogin", component: Ut },
        { path: "/Dzxz", name: "Dzxz", component: $t },
        { path: "/MhHome", name: "MhHome", component: Yt },
        { path: "/loading", name: "loading", component: Ft },
        { path: "/mhmore", name: "mhmore", component: Kt },
        { path: "/loginXy", name: "loginXy", component: Qt },
      ],
      nn = function (t) {
        return e
          .e("BidList")
      ...
      mn = [
        { path: "/BidList", name: "BidList", component: nn },
        { path: "/BidDetail", name: "BidDetail", component: en },
        { path: "/BidRule", name: "BidRule", component: on },
        { path: "/BidResult", name: "BidResult", component: rn },
        { path: "/BidMemberList", name: "BidMemberList", component: cn },
        { path: "/BidMemberEdit", name: "BidMemberEdit", component: an },
        { path: "/BidMemberView", name: "BidMemberView", component: un },
        { path: "/BidMemberHistory", name: "BidMemberHistory", component: sn },
        { path: "/BidMemberResult", name: "BidMemberResult", component: dn },
      ],
      fn = function (t) {
        return e
          .e("XjList")
      ...
      jn = [
        { path: "/XjList", name: "XjList", component: fn },
        { path: "/XjDetail", name: "XjDetail", component: ln },
        { path: "/XjResult", name: "XjResult", component: pn },
        { path: "/XjRule", name: "XjRule", component: hn },
        { path: "/XjMemberList", name: "XjMemberList", component: bn },
        { path: "/XjMemberEdit", name: "XjMemberEdit", component: xn },
        { path: "/XjMemberView", name: "XjMemberView", component: gn },
        { path: "/XjMemberHistory", name: "XjMemberHistory", component: Sn },
        { path: "/XjMemberResult", name: "XjMemberResult", component: yn },
      ],
      vn = function (t) {
        return e
          .e("BidHallList")
      ...
      zn = [
        { path: "/BidHallList", name: "BidHallList", component: vn },
        { path: "/BidHallListNoImg", name: "BidHallListNoImg", component: On },
        { path: "/BidGysHall", name: "BidGysHall", component: wn },
        { path: "/BidJbrHall", name: "BidJbrHall", component: An },
        { path: "/BidMsgList", name: "BidMsgList", component: _n },
        { path: "/BidSupList", name: "BidSupList", component: Ln },
      ],
      Pn = function (t) {
        return e
          .e("ZjHome")
      ...
      En = function (t) {
        return Promise.all([e.e("ZjSfrz~ZjSxqm"), e.e("ZjSxqm")])
          .then(
            function () {
              return t(e("6ba4"));
            }.bind(null, e)
      ...
      qn = function (t) {
        return Promise.all([e.e("ZjSfrz~ZjSxqm"), e.e("ZjSfrz")])
          .then(
            function () {
              return t(e("f545"));
            }.bind(null, e)
      ...
      Wn = [
        { path: "/ZjHome", name: "ZjHome", component: Pn },
        { path: "/ZjSxqm", name: "ZjSxqm", component: En },
        { path: "/ZjSfrz", name: "ZjSfrz", component: qn },
        { path: "/ZjGrxx", name: "ZjGrxx", component: kn },
        { path: "/Qmym", name: "Qmym", component: Xn },
        { path: "/CaLogin", name: "CaLogin", component: Bn },
        { path: "/CaXx", name: "CaXx", component: Cn },
        { path: "/CaZsbg", name: "CaZsbg", component: Mn },
        { path: "/CaXz", name: "CaXz", component: In },
        { path: "/CaZhmm", name: "CaZhmm", component: Tn },
        { path: "/CaXgmm", name: "CaXgmm", component: Gn },
        { path: "/CaSmqz", name: "CaSmqz", component: Nn },
        { path: "/CaSmjjm", name: "CaSmjjm", component: Rn },
        { path: "/CaSmjm", name: "CaSmjm", component: Jn },
        { path: "/CaLoginXx", name: "CaLoginXx", component: Dn },
      ],
      Hn = function (t) {
        return e
          .e("KqTj")
      ...
      se = [
        { path: "/MoreLsjl", name: "MoreLsjl", component: ue },
        { path: "/QjxxXq", name: "QjxxXq", component: ce },
        { path: "/KqTj", name: "KqTj", component: Hn },
        { path: "/KqWz", name: "KqWz", component: Zn },
        { path: "/KqTxl", name: "KqTxl", component: Vn },
        { path: "/Sczb", name: "Sczb", component: Un },
        { path: "/RzIndex", name: "RzIndex", component: Yn },
        { path: "/TbGzrz", name: "TbGzrz", component: Fn },
        { path: "/CkGzrz", name: "CkGzrz", component: Kn },
        { path: "/XzGzrzXm", name: "XzGzrzXm", component: Qn },
        { path: "/LlGzrz", name: "LlGzrz", component: $n },
        { path: "/ShGzrz", name: "ShGzrz", component: te },
        { path: "/XzrzCyy", name: "XzrzCyy", component: ne },
        { path: "/ShGzrzJL", name: "ShGzrzJL", component: ee },
        { path: "/ShGzrzYl", name: "ShGzrzYl", component: oe },
        { path: "/QjList", name: "QjList", component: ie },
        { path: "/ZjQjxx", name: "ZjQjxx", component: re },
        { path: "/Nqdk", name: "Nqdk", component: ae },
      ];
    i["a"].use(r["a"]);
    var de = new r["a"]({
      routes: [].concat(
  ...
  d342: function (t, n, e) {
    ...
    var o = e("365c"),
      ...
      g = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getDataTabCheckMsgs?token=" +
            Object(i["c"])(),
          method: "post",
          token: !0,
          data: { executorid: t },
      ...
      y = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getSubmitxxMap?token=" +
            Object(i["c"])(),
          method: "post",
          token: !0,
          data: { id: t },
      ...
      j = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getBackxxMap?token=" + Object(i["c"])(),
          method: "post",
          token: !0,
          data: { id: t },
        });
      ...
      v = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getHqxxMap?token=" + Object(i["c"])(),
          method: "post",
          token: !0,
          data: { id: t },
        });
      ...
      _ = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/sign/" +
            t.id +
            "?token=" +
            Object(i["c"])(),
          method: "get",
      ...
      z = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getDbxqHead?token=" + Object(i["c"])(),
          method: "post",
          token: !0,
          data: t,
        });
      ...
      I = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/backonestep?token=" + Object(i["c"])(),
          method: "post",
          token: !0,
          data: t,
        });
      ...
      M = function (t) {
        return o["a"].request({
          url:
            "/app/web/authentication/wf/getsplitloglist?token=" +
            Object(i["c"])(),
          method: "post",
          token: !0,
          data: t,
...
//# sourceMappingURL=app.c1573c34.js.map
